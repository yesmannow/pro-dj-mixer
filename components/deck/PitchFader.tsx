...
export function PitchFader({
  ...
  return (
    <div className={compact ? 'flex flex-col items-center gap-1.5' : 'flex flex-col items-center gap-2'}>
      ...
      <div className={compact ? 'relative h-24 w-7 fader-track rounded-full border border-slate-800 bg-slate-950/40 flex items-center justify-center' : 'relative h-32 w-8 fader-track rounded-full border border-slate-800 bg-slate-950/40 flex items-center justify-center'}>
